...
export class URLinearInputComponent implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public init(
		...
		this.labelElement.setAttribute("class", "UR_LinearRangeLabel");

...
import { CheckInstructionOverview, RecordOverviewProps, CurrentRecordInfo } from './components/CheckInstructionOverview';


export class CheckInstructionComponent implements ComponentFramework.StandardControl<IInputs, IOutputs> {
